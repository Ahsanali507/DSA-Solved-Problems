...
//			while (curNode->next != NULL) {        // so jb tk node ka next null nhi
//				curNode = curNode->next;           // tb tk curNode jo k head tha wo next next hota jaye
//			}
//			curNode->next = newNode;                     // agr curNode k next me null ho to wahan newNode rkh do
//			newNode->prev = curNode;                        // or newNode k previous me curNode rkh do
//		}
//	}
//
//	void traverse() {
